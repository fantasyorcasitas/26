...
Sistema de deuda permitida (hasta un 7% del patrimonio).
...
Calendario de competiciones con Start Lists y resultados.

Diseño Responsive: Interfaz 100% adaptada a móviles (Menú hamburguesa, tablas deslizables, scroll infinito).
...
Crear y editar Competiciones.

Introducir resultados de carreras.

# Actualización en Tiempo Real: 

Los cambios se reflejan instantáneamente en la app de los usuarios gracias a Firebase.

## 🛠️ Tecnologías Utilizadas
Frontend: HTML5, CSS3 (Diseño Glassmorphism & Clean UI), JavaScript (ES6 Modules).

Backend & DB: Google Firebase (Firestore Database & Authentication).
