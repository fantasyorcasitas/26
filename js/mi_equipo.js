...
function renderSlot(index, elementId) {
    ...
    if (player) {
        ...
        container.innerHTML = `
            ...
            <div class="slot-price">${player.precio.toFixed(1)}M</div>
            ${actionsHTML}
        `;
    ...
    available.forEach(p => {
        ...
        div.innerHTML = `
            ...
            <div style="flex-grow:1;">
                ...
                <div style="color:#ff5e00; font-size:0.8rem;">${p.precio.toFixed(1)}M | ${p.categoria || 'JUG'}</div>
            </div>
